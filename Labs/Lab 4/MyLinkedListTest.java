...
class MyLinkedListTest {
    ...
    @Test
    void addingIntegersOutOfBounds() {
        MyLinkedList<Integer> myLinkedList = new MyLinkedList<>();
        myLinkedList.add(1);
        myLinkedList.add(2);
        myLinkedList.add(3);
        assertThrows(IndexOutOfBoundsException.class, () -> myLinkedList.add(4, 4));
    }
    ...
    void removeOutOfBounds() {
        ...
        myLinkedList.add(2);
        myLinkedList.add(3);
        assertThrows(IndexOutOfBoundsException.class, () -> myLinkedList.remove(4));
